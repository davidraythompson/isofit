...
from isofit.surface import Surface, ThermalSurface, MultiComponentSurface 
from isofit.surface import TPWSurface, GlintSurface, LUTSurface
...
class ForwardModel:
    ...
    def __init__(self, full_config: Config):
        ...
        elif self.config.surface.surface_category == 'tpw_surface':
            self.surface = TPWSurface(self.full_config)
        else:
